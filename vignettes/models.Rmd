---
title: "4. Choosing LLM Providers and Configuring Models"
---
...
Never hard-code API keys in your scripts. Always use environment variables to store sensitive credentials.
...
OpenRouter provides a unified API to access hundreds of open-source and proprietary models from a single endpoint. This is perfect for:
